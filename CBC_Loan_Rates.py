...
def makeDataRequestFor(amount, category, duration):
    ...
    headers = {
        ...
        'Host': "www.cbc.be",
        'Cookie': "PSASESSIONID=AAC0D685D775F9D4F5310C3EA71FA871.1; TS015834e9=01998c50f2476b29ba9c14abbf8f2021528aded"
                  "eb2f6b6a6d701478385ec12c5b57f18ece7f7a9f5572bce3c1bf250f2061fd498bc058dbfc1708d955d7a9712fdea9dcee79"
                  "dda707721a559292f15618074f0606a617e48f7254a5889429aef234b987b264ddf770982cb375f789513a6b9ea957c4db"
                  "481f590c3ca722ded42206fd496732107ba6743c8f64d37da95278695ebdf; sat_track=true; TS0127c266=01998c50"
                  "f2902f26813df43ea273eea35760806f3130619ae7ca37ac4dcceee49907fccbbdbe33b856d799ebfe84cf18a5eed920ef8"
                  "86c50252775d8a6c34f1590b97bc880fb9f763b80ad7996646cbe9d7a4360e4ce427d80683a80d7ff3f2b873b47125ea793"
                  "47d304bcf00f69b59ef3ca680b91; PD_STATEFUL_78a410d6-37ca-11e9-8a4c-005056864a2c=%2FPSA; PD_STATEFUL_8"
                  "6b729b0-37ca-11e9-8a4c-005056864a2c=VHWWWCBCBE; PD_STATEFUL_863cdc9a-30a5-11e9-bf0b-00505686a95a=%2F"
                  "PSA; PD_STATEFUL_005d13d0-30ad-11e9-b67a-00505683782b=%2FPSA; TS011f471c=01998c50f2e1bc4496f7e8cf4d"
                  "24cafdb96d9160ac2730728beea89b054daeb8ad31c39cf838a716a3c9679e2355bbdc66f8cbd3f865bddba0ecbf5e2184c"
                  "ac4673b7f0b1e5924d2fdbc277542e7484a46714553efc8171b6ca10809ded3c477da4d563bac81417700d7a17e8b5b778d4"
                  "4ed05db217fa4dd6883a0821e08ef2ec5dadb296c",
        'cache-control': "no-cache"
    }
...
def cbcLoanScraper():
    ...
    return DataUtils.data_processing_last(cbcBankData, 'CBC BANK', 'CBC BANK SCRAPE', 'cbc_rates', tab_Column)


# cbcLoanScraper()

# DataUtils.scrape_and_notify(cbcLoanScraper(), "CBC", DataUtils.test_mail)
